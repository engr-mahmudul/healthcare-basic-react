    ...
    return (
        <div >
            <div className='welcome-part'>
                <h1 className='pt-4 px-2'>Welcome  <span style={{ color: 'goldenrod' }}>{user.displayName}</span> sir, </h1>
                <h3>For Investigating Us</h3>
                <Row className='pt-5 intro'>
                    <Col lg={6} sm={12} xs={12}>
                        <img src={founder} alt="" style={{ width: "70%", height: '260px' }} />
                        <div className='mt-4'>
                    ...
                    <Col lg={6} sm={12} xs={12}>
                        <img src={cofounder} alt="" style={{ width: "70%", height: '260px' }} />
                        <div className='mt-4'>
                ...
                <Row className='py-5 intro'>
                    <Col lg={6} sm={12} xs={12}>
                    <div>
                            <img src={award1} alt="" style={{ width: "70%", height: '300px', border:"2px solid green",borderRadius:"10px" }} />
                    ...
                    <Col lg={6} sm={12} xs={12}>
                        <div>
                            <img src={award2} alt="" style={{ width: "70%", height: '300px', border:"2px solid green",borderRadius:"10px" }} />
